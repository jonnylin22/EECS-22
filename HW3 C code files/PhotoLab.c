/********************************************************/
/* PhotoLab.c : contains main() function, menu 		*/
/*	function PrintMenu(), and AutoTest()		*/
/********************************************************/
...
void PrintMenu() {
	...
	printf("12: Create a fisheye image\n");
	printf("13: Posterize an image\n");
	printf("14: Rotate and zoom an image\n");
	printf("15: Blur an image\n");
	printf("16: Test all functions\n");
	printf("17: Exit\n");
}
...
int main() {
	...
	/* Rotate parameters */
	double rotation_angle, scale_factor;
	int CenterX, CenterY;	
	/* MotionBlur() paramters */
	int BlurAmount;
	...
	while (option != EXIT) {
		...
		/* menu item 2 - 15 requires image is loaded first */
			...
			/* now image is loaded */
				...
				switch(option) {
					...
					case 14:
						...
						scanf("%d", &CenterY);
						Rotate(R, G, B, rotation_angle, scale_factor, CenterX, CenterY);
